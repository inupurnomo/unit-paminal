                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <h6 class="me-3"><a href="javascript:void(0)"
                                                        class="text-heading">Google - Google Home - White</a></h6>
                                                <div class="mb-1 d-flex flex-wrap"><span class="me-1">Sold by:</span>
                                                    <a href="javascript:void(0)" class="me-1">Google</a> <span
                                                        class="badge bg-label-success rounded-pill">In Stock</span>
                                                </div>
                                                <div class="read-only-ratings mb-2 px-0" data-rateyo-read-only="true">
                                                </div>
                                                <input type="number" class="form-control form-control-sm w-px-100 mt-4"
                                                    value="1" min="1" max="5">
                                            </div>
                                            <div class="col-md-4">
                                                <div class="text-md-end">
                                                    <button type="button" class="btn-close btn-pinned"
                                                        aria-label="Close"></button>
                                                    <div class="my-2 mt-md-4 mb-md-5"><span
                                                            class="text-primary">$299/</span><span
                                                            class="text-body">$359</span></div>
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-primary mt-3">Move to
                                                        wishlist</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <h6 class="me-3"><a href="javascript:void(0)"
                                                        class="text-heading">Apple iPhone 11 (64GB, Black)</a></h6>
                                                <div class="mb-1 d-flex flex-wrap"><span class="me-1">Sold
                                                        by:</span> <a href="javascript:void(0)"
                                                        class="me-1">Apple</a> <span
                                                        class="badge bg-label-success rounded-pill">In Stock</span>
                                                </div>
                                                <div class="read-only-ratings mb-2 px-0" data-rateyo-read-only="true">
                                                </div>
                                                <input type="number"
                                                    class="form-control form-control-sm w-px-100 mt-4" value="1"
                                                    min="1" max="5">
                                            </div>
                                            <div class="col-md-4">
                                                <div class="text-md-end">
                                                    <button type="button" class="btn-close btn-pinned"
                                                        aria-label="Close"></button>
                                                    <div class="my-2 mt-md-4 mb-md-5"><span
                                                            class="text-primary">$899/</span><span
                                                            class="text-body">$999</span></div>
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-primary mt-3">Move to
                                                        wishlist</button>
                                                </div>
                        ...
                        <div class="border rounded p-3 mb-3">
                            ...
                            <dl class="row mb-0">
                                ...
                                <dd class="col-6 text-end"><s class="text-muted">$5.00</s> <span
                                        class="badge bg-label-success rounded-pill">Free</span></dd>
                                ...
                                <div class="form-check custom-option custom-option-basic checked">
                                    <label class="form-check-label custom-option-content" for="customRadioAddress1">
                                        ...
                                        <span class="custom-option-body">
                                            <small class="d-xxl-block pe-xxl-5 me-xxl-5">4135 Parkway Street, Los
                                                Angeles, CA, 90017.<br /> Mobile : 1234567890 Cash / Card on delivery
                                                available</small>
                                            <span class="my-2 border-bottom d-block"></span>
                                            <span class="d-flex">
                                                <a class="me-3" href="javascript:void(0)">Edit</a> <a
                            ...
                            <div class="col-md">
                                <div class="form-check custom-option custom-option-basic">
                                    <label class="form-check-label custom-option-content" for="customRadioAddress2">
                                        ...
                                        <span class="custom-option-body">
                                            <small class="d-xxl-block pe-xxl-5 me-xxl-5">8723 Schoffman Avenue, New
                                                York, NY, 10016.<br />Mobile : 1234567890 Cash / Card on delivery
                                                available</small>
                                            <span class="my-2 border-bottom d-block"></span>
                                            <span class="d-flex">
                                                <a class="me-3" href="javascript:void(0)">Edit</a> <a
                        ...
                        <div class="alert alert-success" role="alert">
                            <div class="d-flex gap-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li> - 0% Instant Discount on Bank of America Corp Bank Debit and Credit cards
                                        </li>
                                        <li> - 50% Cashback Voucher of up to $60 on first ever PayPal transaction. TCA
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <span class="input-group-text w-px-75" id="paymentCard2"><span
                                                        class="card-type"></span></span>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating form-floating-outline">
                                                <input id="paymentCardName" name="paymentCardName"
                                                    class="form-control" type="text" placeholder="John Doe" />
                                                <label for="paymentCardName">Name</label>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-3">
                                            <div class="form-floating form-floating-outline">
                                                <input id="paymentCardExpiryDate" name="paymentCardExpiryDate"
                                                    class="form-control expiry-date-mask" type="text"
                                                    placeholder="MM/YY" />
                                        ...
                                        <div class="col-12">
                                            <label class="switch">
                                                ...
                                                <span class="switch-label text-heading">Save card for future
                                                    billing?</span>
                                            </label>
                                        </div>
                                        <div class="col-12">
                                            <button type="button"
                                                class="btn btn-primary btn-next me-sm-3 me-1 text-uppercase">Simpan</button>
                                            <button type="reset"
                                                class="btn btn-outline-secondary text-uppercase">Reset</button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4">
                        <div class="border rounded p-3">
                            ...
                            <dl class="row mb-0">
                                ...
                                <dt class="col-6 fw-normal text-heading">Delivery Charges</dt>
                                <dd class="col-6 text-end"><s class="text-muted me-1">$5.00</s> <span
                                        class="badge bg-label-success rounded-pill">Free</span></dd>
                            ...
                            <dl class="row gy-2">
                                ...
                                <dd class="col-6 fw-medium text-end mb-0"><span
                                        class="badge bg-label-primary rounded-pill">Home</span></dd>
                            </dl>
                            <!-- Address Details -->
                            <address>
            ...
            <div id="checkout-confirmation" class="content">
                <div class="row mb-3">
                    <div class="col-12 col-lg-8 mx-auto text-center mb-3">
                        ...
                        <p>Your order <a href="javascript:void(0)" class="h6 mb-0">#1536548131</a> has been placed!
                        </p>
                        <p>We sent an email to <a href="mailto:john.doe@example.com"
                                class="h6 mb-0">john.doe@example.com</a> with your order confirmation and receipt. If
                            the email hasn't arrived within two minutes, please check your spam folder to see if the
                            email was routed there.</p>
                        <p><span class="fw-medium"><i class="mdi mdi-clock-outline text-heading me-1"></i></span>Time
                            placed: 25/05/2020 13:35pm</p>
                    </div>
                    <!-- Confirmation details -->
                    <div class="col-12">
                        <ul class="list-group list-group-horizontal-md">
                            <li class="list-group-item flex-fill">
                                <h6 class="d-flex align-items-center gap-2"><i class="mdi mdi-map-marker-outline"></i>
                                    Shipping</h6>
                            ...
                            <li class="list-group-item flex-fill">
                                <h6 class="d-flex align-items-center gap-2"><i
                                        class="mdi mdi-credit-card-outline"></i> Billing Address</h6>
                                <address class="text-body">
                                    John Doe <br />
                                    4135 Parkway Street,<br />
                                    Los Angeles, CA 90017,<br />
                            ...
                            <li class="list-group-item flex-fill">
                                <h6 class="d-flex align-items-center gap-2"><i class="mdi mdi-ferry"></i> Shipping
                                    Method</h6>
