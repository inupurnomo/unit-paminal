...
@section('title', 'Laporan List - Pages')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <div class="d-flex  justify-content-between">
                ...
                <a href="{{ route('laporan.tambah') }}">
                    <button class="btn btn-primary btn-sm">Tambah Laporan</button>
                </a>
        ...
        <div class="card-datatable table-responsive">
            <table class="datatables-laporan table">
    ...
    <div class='modal fade' id='submitModal' tabindex='-1' role='dialog' aria-labelledby='submitModalLabel'
        ...
        <div class='modal-dialog' role='document'>
            ...
            <div class='modal-content'>
                ...
                <div class='modal-footer'>
                    <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Cancel</button>
                    <button type='button' class='btn btn-primary' onclick="submitLaporan()"
