          ...
          <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
            <div class="user-profile-info">
              ...
              <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                ...
                <i class='mdi mdi-invert-colors me-1 mdi-20px'></i><span class="fw-medium">{{ $profile->username }}</span>
                </li>
                <li class="list-inline-item">
                  <i class='mdi mdi-star-outline me-1 mdi-20px'></i><span class="fw-medium">{{ $profile->role }}</span>
                </li>
                <li class="list-inline-item">
                  <i class='mdi mdi-calendar-blank-outline me-1 mdi-20px'></i><span class="fw-medium"> Joined {{ $profile->joined }}</span></li>
              </ul>
            </div>
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <ul class="list-unstyled my-3 py-1">
          <li class="d-flex align-items-center mb-3"><i class="mdi mdi-account-outline mdi-24px"></i><span class="fw-medium mx-2">Full Name:</span> <span>{{ $profile->name }}</span></li>
          <li class="d-flex align-items-center mb-3"><i class="mdi mdi-invert-colors mdi-24px"></i><span class="fw-medium mx-2">Username:</span> <span>{{ $profile->username }}</span></li>
          <li class="d-flex align-items-center mb-3"><i class="mdi mdi-star-outline mdi-24px"></i><span class="fw-medium mx-2">Role:</span> <span>{{ $profile->role }}</span></li>
          @if ($profile->role == 'pengacara')
          <li class="d-flex align-items-center mb-3"><i class="mdi mdi-check mdi-24px"></i><span class="fw-medium mx-2">Kategori:</span> <span>{{ $profile->kategori }}</span></li>
          @endif
        </ul>
        <small class="card-text text-uppercase">Contacts</small>
        <ul class="list-unstyled my-3 py-1">
          <li class="d-flex align-items-center mb-3"><i class="mdi mdi-phone-outline mdi-24px"></i><span class="mx-2">{{ $profile->phonenumber }}</span></li>
          <li class="d-flex align-items-center mb-3"><i class="mdi mdi-email-outline mdi-24px"></i><span class="mx-2">{{ $profile->email }}</span></li>
        </ul>
        <a href="{{ route('profile.ubah_password') }}" class="btn btn-danger">
            <i class='mdi mdi-account-check-outline me-1'></i>Ubah Password
          </a>
      </div>
    </div>
    <!--/ About User -->
