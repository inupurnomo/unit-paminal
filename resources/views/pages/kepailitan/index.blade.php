...
@section('title', 'Kepailitan List - Pages')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <div class="d-flex  justify-content-between">
                <h5 class="card-title">Daftar Kepailitan</h5>
                <a href="{{ route('kepailitan.tambah') }}">
                    <button class="btn btn-primary btn-sm">Tambah Kepailitan</button>
                </a>
        ...
        <div class="card-datatable table-responsive">
            <table class="datatables-kepailitan table">
