...
@section('content')
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Kepailitan /</span> Tambah Kepailitan
    </h4>
    <!-- Basic Layout -->
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Form Kepailitan</h5> <small class="text-body float-end"></small>
                </div>
                <div class="card-body">
                    <form class="needs-validation" novalidate id="formcreatekepailitan" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="file" id="formDokumen" name="dokumen_pendukung[]" multiple>
                        </div>

                        <button type="submit" class="btn btn-primary mt-4">Simpan Kegiatan</button>
