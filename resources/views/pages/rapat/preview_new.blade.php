...
@section('content')
    ...
    <div class="row invoice-preview">
            ...
            <div class="card invoice-preview-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
                        ...
                        <div>
                            <h4 class="fw-medium">No Perkara : {{ $data->kepailitan->no_perkara }}</h4>
                            <div class="mb-1">
                                <span>Tanggal :</span>
                        ...
                        <div class="image-slider">
                            @foreach ($foto_kegiatan as $item)
                                <a class="image-link" data-bs-toggle="modal" data-bs-target="#imageModal">
                                    <img height="150" class="col-md-3" src="{{ asset("file/$item->file") }}"
                                        alt="">
                                </a>
                            @endforeach
                        </div>
                        ...
                        <div class="col-md-6 mb-md-0 mb-3">
                            <div>
                                <p class="mb-2">
                                    ...
                                    <span>{{ $data->kepailitan->leader }}</span>
                                </p>
        ...
        <div class="col-xl-4 col-md-4 col-12 invoice-actions">
            @if ($data->id_status == 2 || $data->id_status == 4)
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Rapat</h5> <small class="text-body float-end"></small>
                    </div>
                    <div class="card-body">
                        @if (
                            $data->id_status == 2 &&
                            ...
                            <form class="forms-approved mb-4" onsubmit="return false;" novalidate id="formapprove">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 sm-12">
                                        <div class="form-floating form-floating-outline">
                                            ...
                                            <label for="status">Update Status Rapat</label>
                                        </div>
                                    </div>
                                ...
                                <button id="submitButton" type="submit" kode="{{ $data->id }}"
                                    class="btn btn-primary mt-4">Update Rapat</button>
                            </form>
                        @endif
                        @if ($data->id_status == 4)
                            <a class="btn btn-primary d-grid w-100 mb-3" href="/send_laporan/{{ $data->id }}">
                                <span class="d-flex align-items-center justify-content-center text-nowrap"><i
                                        class="mdi mdi-send-outline scaleX-n1-rtl me-1"></i>Kirim Rapat</span>
                            </a>
            ...
            <div class="card mt-2">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Riwayat Rapat</h5> <small class="text-body float-end"></small>
                </div>
