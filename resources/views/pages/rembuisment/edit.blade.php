                        ...
                        <div class="row">
                            <div class="col-lg-6 md-12">
                                <div class="form-floating form-floating-outline mb-4 has-validation">
                                    <select id="jenis_laporan" class="select2 form-control" name="jenis_laporan"
                                        data-allow-clear="true" required disabled>
                                        <option value="{{ $rembuisment->type_kegiatan }}">{{ $rembuisment->type_kegiatan }}</option>
                                    </select>
                                    <label for="jenis_laporan">Jenis Agenda</label>
                            ...
                            <div class="col-lg-6 md-12">
                                <div class="form-floating form-floating-outline mb-4">
                                    <select id="kegiatan" class="select2 form-control" name="kegiatan"
                                        data-allow-clear="true" required disabled>
                                        <option value="{{ $rembuisment->kegiatan_nama }}">{{ $rembuisment->kegiatan_nama }}</option>
                                    </select>
