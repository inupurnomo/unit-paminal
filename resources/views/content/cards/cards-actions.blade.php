            ...
            <div class="card card-action mb-4">
                ...
                <div class="collapse show">
                    <div class="card-body">
                        ...
                        <p class="card-text">Click on <i class="tf-icons mdi mdi-chevron-up"></i> to see card collapse in
                            action.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md">
            <div class="card card-action mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Click on <i class="tf-icons mdi mdi-rotate-left scaleX-n1-rtl"></i> icon to see
        ...
        <div class="col-md">
            <div class="card card-action mb-4">
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                <a href="javascript:void(0);" class="card-expand"><i
                                        class="tf-icons mdi mdi-fullscreen"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Click on <i class="tf-icons mdi mdi-fullscreen"></i> icon to see expand card in
                        action.</p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-action mb-4">
                ...
                <div class="card-body">
                    <p class="card-text">Remove card action hide the card, use <code>.card-close</code> class with action
                        item.</p>
                    <br />
                    <p class="card-text">Click on <i class="tf-icons mdi mdi-close"></i> icon to see remove card in action.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="card-header header-elements">
                    ...
                    <div class="card-header-elements ms-auto">
                        <button type="button" class="btn btn-xs btn-primary"><span
                                class="tf-icon mdi mdi-plus me-1"></span>Button</button>
                    </div>
                </div>
                <div class="card-body">
