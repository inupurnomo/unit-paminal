                        ...
                        <div class="card-body">
                            <form id="formAccountSettingsApiKey" method="POST" onsubmit="return false">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary me-2 d-grid w-100 mt-n1">Create
                                            Key</button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-md-7">
                        <div class="text-center mt-4 mx-3 mx-md-0">
                            <img src="{{ asset('assets/img/illustrations/account-settings-security-illustration.png') }}"
                                class="img-fluid" alt="Api Key Image" width="140">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="bg-lighter rounded p-3 mb-3 position-relative">
                                <div class="dropdown api-key-actions">
                                    <a class="btn dropdown-toggle text-light hide-arrow p-0" data-bs-toggle="dropdown"><i
                                            class="mdi mdi-dots-vertical mdi-24px"></i></a>
                        ...
                        <tbody>
                            <tr>
                                <td class="text-truncate text-heading"><i
                                        class='mdi mdi-laptop mdi-20px text-warning me-3'></i>Chrome on Windows</td>
                            ...
                            <tr>
                                <td class="text-truncate text-heading"><i
                                        class='mdi mdi-android mdi-20px text-success me-3'></i>Chrome on iPhone</td>
                            ...
                            <tr>
                                <td class="text-truncate text-heading"><i
                                        class='mdi mdi-cellphone mdi-20px text-danger me-3'></i>Chrome on Android</td>
                            ...
                            <tr>
                                <td class="text-truncate text-heading"><i
                                        class='mdi mdi-monitor mdi-20px text-info me-3'></i>Chrome on MacOS</td>
                            ...
                            <tr class="border-transparent">
                                <td class="text-truncate text-heading"><i
                                        class='mdi mdi-android mdi-20px text-success me-3'></i>Chrome on Android</td>
                                <td class="text-truncate">Oneplus 9 Pro</td>
                                <td class="text-truncate">Dubai</td>
